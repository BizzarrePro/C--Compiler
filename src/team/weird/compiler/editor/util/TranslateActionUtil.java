...
public class TranslateActionUtil{
	...
	public static  String translateToEn(String q) throws Exception{
		ApplicationContext container=new FileSystemXmlApplicationContext("src//team//weird//compiler//editor//util//baidu.xml");
		TranslateActionUtil baidu = (TranslateActionUtil)container.getBean("baidu");
